...
class Financial(models.Model):
    ...
    active2_average_price = models.DecimalField(default = 0, blank = False, null = False, max_digits=19, decimal_places=10)
    active3_average_price = models.DecimalField(default = 0, blank = False, null = False, max_digits=19, decimal_places=10)
...
class Transactions(models.Model):
    ...
    asset_id = models.CharField(max_length= 3, blank = False, null = False)# asset_id = 1,2,3
